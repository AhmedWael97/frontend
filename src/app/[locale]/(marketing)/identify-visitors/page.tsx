    ...
    <div dir={t.dir} className="min-h-screen bg-background text-on-surface">
      ...
      <main className="max-w-5xl mx-auto px-4">
        <section className="text-center py-16 sm:py-24">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-bold text-emerald-600 dark:text-emerald-400 mb-5"><ShieldCheck className="w-3.5 h-3.5" />GDPR · B2B</span>
        ...
        <section className="py-12 border-t border-outline-variant/10">
          <h2 className="text-2xl sm:text-3xl font-black mb-6">{t.stepsH}</h2>
        ...
        <section className="py-12 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6 my-4">
