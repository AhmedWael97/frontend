...
// "classic" = pre-brutalist-redesign design, restored verbatim from git history
// (commit 8781d54) as the control arm for the redesign A/B test. Own copies of
// Navbar/Footer/etc so this page doesn't touch the shared components the rest
// of the (live, brutalist) marketing site uses.
import Navbar from "@/components/marketing/classic/Navbar";
import MobileCtaBar from "@/components/marketing/classic/MobileCtaBar";
import LiveStatsStrip from "@/components/marketing/classic/LiveStatsStrip";
import PricingTeaser from "@/components/marketing/classic/PricingTeaser";
import GoogleOneTap from "@/components/auth/GoogleOneTap";
import Footer from "@/components/marketing/classic/Footer";
...
export async function generateMetadata(
  ...
  return {
    ...
    // A/B test variant of the homepage, not a page of its own — never index it.
