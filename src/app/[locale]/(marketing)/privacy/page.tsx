    ...
    <>
      ...
      <main className="bg-black min-h-screen pt-16 sm:pt-20 pb-20">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 pt-8">
          <div className="inline-flex items-center gap-2 rounded-none border border-green-500/30 bg-green-500/10 px-3.5 py-1.5 mb-6">
            <ShieldCheck className="w-4 h-4 text-green-400" />
            <span className="text-[11px] sm:text-xs font-semibold tracking-widest uppercase text-green-400" style={{ fontFamily: "var(--font-mono-marketing)" }}>
              {c.title}
            </span>
          </div>
